...
CREATE TABLE `activities` (
  ...
  PRIMARY KEY (`ID`),
  KEY `fk_activities_rooms1_idx` (`rooms_Room Number`,`rooms_Buildings_Building Number`),
  CONSTRAINT `fk_activities_rooms1` FOREIGN KEY (`rooms_Room Number`, `rooms_Buildings_Building Number`) REFERENCES `rooms` (`Room Number`, `Buildings_Building Number`)
